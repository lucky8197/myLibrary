...
public class Book {
	...
	// 初始化全部成员变量的构造方法
	public Book(Integer id, String book_name, String book_type, String book_case, String author, String book_concern,
			Float price, Integer count, Integer page, Date inTime, Integer borrownum) {
		super();
		this.id = id;
